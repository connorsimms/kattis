...
int main() {
	...
	double d1 = distToLineSegment(a1, b1, b2, closest1);
	double d2 = distToLineSegment(a2, b1, b2, closest2);
	double d3 = distToLineSegment(b1, a1, a2, closest3);
	double d4 = distToLineSegment(b2, a1, a2, closest4);

	bool c1 = (ccw(b1, b2, a1) != ccw(b1, b2, a2));
	bool c2 = (ccw(a1, a2, b1) != ccw(a1, a2, b2));
	...
	cout << fixed << setprecision(2) << min(v1, v2) << '\n';
    }
}
